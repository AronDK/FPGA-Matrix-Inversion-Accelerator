...
HD_PWD='/media/junningfan/SSD_LITEON/UbuntuShared/4601/Vivado/baseDesign_stream/baseline_hls.runs/design_4_fir_stream_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_4_fir_stream_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_4_fir_stream_0_2.tcl
