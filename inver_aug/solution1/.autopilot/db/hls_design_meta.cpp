...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("B_V_address0", 7, hls_out, 1, "ap_memory", "mem_address", 1),
	Port_Property("B_V_ce0", 1, hls_out, 1, "ap_memory", "mem_ce", 1),
	Port_Property("B_V_we0", 1, hls_out, 1, "ap_memory", "mem_we", 1),
	Port_Property("B_V_d0", 22, hls_out, 1, "ap_memory", "mem_din", 1),
	Port_Property("B_V_address1", 7, hls_out, 1, "ap_memory", "MemPortADDR2", 1),
	Port_Property("B_V_ce1", 1, hls_out, 1, "ap_memory", "MemPortCE2", 1),
	Port_Property("B_V_we1", 1, hls_out, 1, "ap_memory", "MemPortWE2", 1),
	Port_Property("B_V_d1", 22, hls_out, 1, "ap_memory", "MemPortDIN2", 1),
};
