...
// ==============================================================
#ifndef __inverse_sdiv_36nscud__HH__
#define __inverse_sdiv_36nscud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inverse_sdiv_36nscud) {
    ...
    SC_CTOR(inverse_sdiv_36nscud):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
