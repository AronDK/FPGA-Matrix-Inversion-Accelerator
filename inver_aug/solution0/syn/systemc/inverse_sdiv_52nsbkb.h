...
// ==============================================================
#ifndef __inverse_sdiv_52nsbkb__HH__
#define __inverse_sdiv_52nsbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(inverse_sdiv_52nsbkb) {
    ...
    ACMP_sdiv_seq<ID, 56, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_sdiv_seq_U;

    SC_CTOR(inverse_sdiv_52nsbkb):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
