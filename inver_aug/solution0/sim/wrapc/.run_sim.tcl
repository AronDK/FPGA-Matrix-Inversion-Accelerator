...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "inverse.autotvin.dat"
	set constFileTvOut       "inverse.autotvout.dat"
	set constFileHdlTvIn     "inverse.autohdltvin.dat"
	set constFileHdlTvOut    "inverse.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
