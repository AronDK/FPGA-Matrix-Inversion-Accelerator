...
$(ObjDir)/inver_aug_test.cpp_pre.cpp.tb.o : inver_aug_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling inver_aug_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/inver_aug.cpp_pre.cpp.tb.o : inver_aug.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling inver_aug.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
