...
set DataType0 [list "intSdCh" "struct intSdCh" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType10 "[list ap_fixed 30 8 5 3 0 ]"
...
set DataType1 [list "intModRet" "struct intModRet" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
